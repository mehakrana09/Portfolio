...
export default function Projects({ projectUrl }: { projectUrl: string }) {
  const projects = [
    {
        ...
        >
          ...
          <div className="p-6">
            ...
            <a
              ...
              className="inline-block bg-green-600 text-white text-sm font-medium px-4 py-2 rounded transition duration-300 hover:bg-red-600"
            >
              GitHub
            </a>
          </div>
